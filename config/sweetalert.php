...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'autoClose' => env('SWEET_ALERT_MIDDLEWARE_TOAST_AUTO_CLOSE', true),
        ...
        'timer' => env('SWEET_ALERT_MIDDLEWARE_TOAST_CLOSE_TIME', 3000),
        ...
        'auto_display_error_messages' => env('SWEET_ALERT_TOAST_AUTO_DISPLAY_ERROR_MESSAGES', true),
    ],
